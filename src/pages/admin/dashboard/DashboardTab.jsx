        ...
        <div>
            <div className="container mx-auto">
                <div className="tab container mx-auto">
                    <Tabs defaultIndex={0}>
                        <TabList className="md:flex md:space-x-8 bg-gray-100 grid grid-cols-2 text-center gap-4 md:justify-center mb-10">
                            <Tab>
                ...
                <div>
                        ...
                        {/* Orders Tab */}
                        <TabPanel>
                            <div className="text-center text-2xl">Orders Tab Content</div>
                        </TabPanel>

                        {/* Users Tab */}
                        <TabPanel>
                            <div className="text-center text-2xl">Users Tab Content</div>
                        </TabPanel>
                    </Tabs>
                </div>
            </div>
